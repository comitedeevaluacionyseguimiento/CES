...
class ProgramasControllerTest < ActionController::TestCase
  ...
  test "should create programa" do
    assert_difference('Programa.count') do
      post :create, programa: { abreviatura: @programa.abreviatura, descripcion: @programa.descripcion, ficha: @programa.ficha }
    end
  ...
  test "should update programa" do
    put :update, id: @programa, programa: { abreviatura: @programa.abreviatura, descripcion: @programa.descripcion, ficha: @programa.ficha }
    assert_redirected_to programa_path(assigns(:programa))
  end
